'''
Decimal numbers are stored in the numbers list as strings. Complete the code below so that for each decimal
number it displays its representation as a common fraction in the format:

decimal = fraction
Note. The program should output
